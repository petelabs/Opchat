          ...
          >
            ...
            <div className="p-6">
              <p className="text-sm text-slate-500 mb-4">
                Enter the 6-character unique ID of the person you want to chat with.
              </p>
              ...
              <form onSubmit={handleSearch} className="flex gap-2 mb-6">
                <div className="relative flex-1">
                  <input
                    ...
                    maxLength={6}
                    className="w-full pl-4 pr-4 py-3 bg-slate-100 rounded-xl font-mono text-lg tracking-widest uppercase focus:outline-none focus:ring-2 focus:ring-emerald-500 transition-all"
                    value={shortId}
                ...
                <button
                  ...
                  className="px-6 py-3 bg-emerald-600 text-white rounded-xl font-semibold hover:bg-emerald-700 disabled:bg-slate-300 disabled:cursor-not-allowed transition-all flex items-center gap-2"
                >
                  {loading ? (
              ...
              {foundUser && (
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="font-bold text-slate-900">{foundUser.displayName}</p>
                      <p className="text-xs text-emerald-600 font-mono font-bold tracking-wider">{foundUser.shortId}</p>
                    </div>
                  </div>
                  <button
                    onClick={startChat}
